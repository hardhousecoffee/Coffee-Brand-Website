...
const posts = [
  {
    ...
    desc: "Compare home espresso machines by workflow, temperature approach, grinder needs, maintenance, and the buyer each design suits.",
  ...
  },
  {
    ...
    desc: "Use a repeatable recipe, staged pours, roast-specific adjustments, and taste-based troubleshooting to improve your pour-over.",
  ...
  },
  {
    ...
    desc: "Choose a dark-roast profile by roast character, freshness, origin transparency, espresso behavior, and the drink you make.",
  ...
  },
  {
    ...
    desc: "Make concentrate or ready-to-drink cold brew with clear ratios, steeping ranges, filtration, storage, and troubleshooting.",
  ...
  },
  {
    ...
    desc: "Compare burrs, adjustment range, retention, noise, cleaning, and espresso-versus-filter workflow before buying a grinder.",
  ...
  },
  {
    ...
    desc: "Compare representative regions, processing methods, roast effects, and brewing choices without reducing either country to one flavor.",
  ...
  },
  {
    ...
    desc: "Compare beginner setups by total cost, grinder needs, milk workflow, maintenance, learning curve, and support.",
  ...
  },
  {
    ...
    desc: "Build a realistic budget around the machine, grinder, scale, coffee, water, maintenance, and the compromises of compact gear.",
  ...
  },
  {
    ...
    desc: "Understand dual boilers, PID control, steam capacity, serviceability, workflow, and diminishing returns before upgrading.",
  ...
  },
  {
    ...
    desc: "A balanced look at the Micra’s dual-boiler workflow, compact controls, maintenance, service, limitations, and alternatives.",
